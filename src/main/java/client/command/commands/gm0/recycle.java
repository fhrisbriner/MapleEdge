...
public class recycle extends Command {
    {
        setDescription("[WARNING] THIS CLEARS ALL ITEMS IN THE SPECIFIC TAB YOU SELECT.");
    }
    ...
    public void execute(Client c, String[] params) {
        ...
        if (params.length < 1) {
            player.yellowMessage("[WARNING] Using this clears every slots in the specific tab!!");
            player.dropMessage(5,"Syntax: !clearslot <all, equip, use, setup, etc or cash.>");
            return;
        }
